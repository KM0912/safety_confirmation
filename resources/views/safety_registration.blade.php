            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method='POST' action="/store">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label registration-lavel">自身の安否</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label registration-lavel">家族の安否</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label registration-lavel">出社可否</label>
                        ...
                        <div class="mb-3">
                            <label for="commentTextarea" class="form-label">{{ __('Comment') }}</label>
                            <textarea name="comment" class="form-control bg-white" id="commentTextarea" rows="3"></textarea>
                        </div>
