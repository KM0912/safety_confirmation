                ...
                <div class="card-body">
                    <form method='POST' action="/store">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="radio" class="btn-check" name="own-condition" id="own-condition-safety" autocomplete="off" value=1 checked>
                            <label class="btn btn-outline-primary" for="own-condition-safety">無事</label>

                            <input type="radio" class="btn-check" name="own-condition" id="own-condition-injured" autocomplete="off" value=2>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="radio" class="btn-check" name="family-condition" id="family-condition-safety" autocomplete="off" value=1 checked>
                            <label class="btn btn-outline-primary" for="family-condition-safety">無事</label>

                            <input type="radio" class="btn-check" name="family-condition" id="family-condition-injured" autocomplete="off" value=2>
                            <label class="btn btn-outline-primary" for="family-condition-injured">負傷</label>

                            <input type="radio" class="btn-check" name="family-condition" id="family-condition-unconfirmed" autocomplete="off" value=3>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="radio" class="btn-check" name="go-to-work" id="go-to-work-yes" autocomplete="off" value=1 checked>
                            <label class="btn btn-outline-primary" for="go-to-work-yes">可能</label>

                            <input type="radio" class="btn-check" name="go-to-work" id="go-to-work-no" autocomplete="off" value=2>
